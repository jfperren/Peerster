...
\section{Related work}
    ...
    \subsection{Mix Networks}
        ...
        This second kind is often distinguished in three\footnote{This does not consider type 0 remailers constituted of a single node, as it is less relevant here.} types. \
    ...
    % \subsection{Tor}
        ...
        Another solution is to have a trusted third party that distributes to all users the required data.
        ...
        An explanation for the attack is given in the Mixminion design\cite{mixminion} paper in Section 6.
...
\section{System goals and functionalities and architecture}
    ...
    \subsection{System goals}\label{subsec:system-goals}
        ...
        We decided to focus on the cyphering and signing of all exchanges, with a mapping $gossiper~name \rightarrow public~key$ stored in the blockchain for different nodes to know the same peers.
    ...
    % - Implement how nodes chose which mix node to sent their message to
        ...
        \subsubsection{Keys Registration \& Routing}
           ...
           \begin{itemize}
               ...
               A field is dedicated to specify if it is the Genesis block, and thus to allow the requester to end his blockchain reconstruction.
                    \begin{lstlisting}

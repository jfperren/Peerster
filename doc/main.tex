...
\section{System goals and functionalities and architecture}
    ...
    % - Implement how nodes chose which mix node to sent their message to
        ...
        \subsubsection{Onion Structure}\label{subsec:onion-structure}
            ...
            The size of an \texttt{OnionPacket} will therefore always be exactly the same (a value which still needs to be define). Furthermore, these bytes are separated into an initial \texttt{Header} followed by a \texttt{Payload}.
